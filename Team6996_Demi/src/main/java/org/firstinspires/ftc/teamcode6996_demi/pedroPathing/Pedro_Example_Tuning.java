...
import static org.firstinspires.ftc.teamcode6996_demi.pedroPathing.Pedro_Example_Tuning.changes;
import static org.firstinspires.ftc.teamcode6996_demi.pedroPathing.Pedro_Example_Tuning.drawOnlyCurrent;
import static org.firstinspires.ftc.teamcode6996_demi.pedroPathing.Pedro_Example_Tuning.draw;
import static org.firstinspires.ftc.teamcode6996_demi.pedroPathing.Pedro_Example_Tuning.follower;
import static org.firstinspires.ftc.teamcode6996_demi.pedroPathing.Pedro_Example_Tuning.stopRobot;
import static org.firstinspires.ftc.teamcode6996_demi.pedroPathing.Pedro_Example_Tuning.telemetryM;
 ...
 */
@Configurable
@TeleOp(name = "Pedro_Pathing_Tuning", group = "Pedro Pathing")
public class Pedro_Example_Tuning extends SelectableOpMode {
 ...
 * is, when paired with StrafeVelocityTuner, allows FollowerConstantsPedro to create a Vector that
 ...
 * reaching the end of the distance, it averages them and prints out the velocity obtained. It is
 * recommended to run this multiple times on a full battery to get the best results. What this does
 * is, when paired with ForwardVelocityTuner, allows FollowerConstantsPedro to create a Vector that
 * empirically represents the direction your mecanum wheels actually prefer to go in, allowing for
 * more accurate following.
 *
 * @author Anyi Lin - 10158 Scott's Bots
