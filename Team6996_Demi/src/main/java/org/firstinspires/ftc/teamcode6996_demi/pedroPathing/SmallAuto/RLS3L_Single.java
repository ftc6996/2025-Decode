...
@Autonomous(name = "RLS3L_Single", group = "Pedro Pathing Small Auto")
public class RLS3L_Single extends OpMode {
...
private int numShots = 3;
    ...
    private final Pose shootPose = new Pose(85,84.25,Math.toRadians(220));
    private final Pose threePose = new Pose(90.75,70,Math.toRadians(220));
    ...
    private void stateLaunchUpdate(){
        ...
        telemetry.addData("LaunchUpdate", launchState);
    }
